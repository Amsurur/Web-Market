  ...
  return (
    <div className=" pt-[50px]">
          ...
          <React.Fragment key={index}>
            <div className="flex gap-[25px] items-center max:flex-wrap dark:text-white">
              <img
                src={product.img}
                alt=""
                className="self-start object-cover w-12 h-12"
              />
              <h1 className="max600:text-[13px]">{product.name}</h1>
            </div>
            <h1 className="dark:text-white max600:text-[10px]">
              {product.price}
            </h1>
            <input
              type="number"
              ...
              className="w-[72px] max600:w-[50px] h-[42px] border-[1.5px] border-solid border-[#00000066] dark:bg-[#272727] pl-[25px] rounded-[4px]"
            />
            ...
            <button
              ...
              className="mr-[300px] max600:text-[13px]"
            >
              Remove
            </button>
          </React.Fragment>
      ...
      <div className="flex justify-around mt-[100px] max:flex-wrap gap-[10px] dark:text-white ">
        <button
          className="w-[218px] h-[56px] rounded-[4px] border-[1px] border-solid border-[#00000080] dark:border-[white]"
          onClick={() => navigate("/")}
        >
          Return To Shop
        </button>
