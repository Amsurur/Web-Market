...
export const Safi = () => {
  return (
    <>
      <div>
        {/* <div className=' pt-[30px] mt-[100px] flex    justify-center  ml-[10%]  w-[80%] bg-[#000000]'>
      <div  className=''>
         <p className=' text-[#00FF66]'>Categories</p>
         <p className=' text-white text-[46px] font-[600]'>Enhance Your </p>
         <p className=' text-white text-[46px] font-[600]' >Music Experience</p>
       <img className=' mt-[10px]' src="src/components/Safisrc/Frame 601.png" alt="" />
      <button className=' w-[200px] mt-[40px] rounded-[10px]  h-[60px] text-white text-[20px] bg-[#00FF66]'>Buy Now</button>
    
       </div>
      
     <div className=' flex  items-center justify-center'>
      <img className=' absolute' src="src/components/Safisrc/Ellipse 23.png" alt="" />
      <img src="src/components/Safisrc/Frame 694.png" alt="" />
     </div>
        ...
        <div className="container  w-[85%] ml-[10%] mt-[50px]">
          <div class="num1">
            <img
              className=" float-right"
              src="src/components/Safisrc/attractive-woman-wearing-hat-posing-black-background 1.png"
              alt=""
            />
          ...
          <div class="num2">
            ...
            <img
              className=" m-auto"
              src="src/components/Safisrc/Frame 706.png"
              alt=""
            />
          </div>
          <div class="num3">
            ...
            <img
              className=" m-auto"
              src="src/components/Safisrc/69-694768_amazon-echo-png-clipart-transparent-amazon-echo-png 1.png"
              alt=""
            />
          </div>
          <div class="num4">
            ...
            <img
              className=" m-auto"
              src="src/components/Safisrc/ps5-slim-goedkope-playstation_large 1.png"
              alt=""
            />
          </div>
        </div>
        ...
        <div className=" flex flex-wrap w-[75%] justify-center gap-[80px] ml-[15%]  mt-[200px]">
          <div>
            ...
            <p className=" text-center  font-[600] text-[18px]  mt-[25px]">
              FREE AND FAST DELIVERY
            </p>
            <p className=" text-center mt-[10px] text-gray-700">
